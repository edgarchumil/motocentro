            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-4 mbmobile">
                    <div class="connect-sorting bg-dark">
                        <h5 class="text-white">Ventas Totales: Q {{number_format($total,2)}}</h5>
                        ...
                        <table class="table table-bordered table-striped mt-1">
                            <thead class="text-white" style="background: #3B3F5C">
                                <tr>
                                    ...
                                    <th class="table-th text-center text-white">ARTÍCULOS</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><h6>Q {{number_format($row->total,2)}}</h6></td>
