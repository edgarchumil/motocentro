<div wire:ignore.self class="modal fade" id="modalDetails" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
          ...
          <table id="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><h6>Q {{number_format($d->price,2)}}</h6></td>
                <td><h6>{{number_format($d->quantity,0)}}</h6></td>
                <td><h6>Q {{number_format($d->price * $d->quantity,2)}}</h6></td>
      ...
      <button type="button" class="btn btn-dark close-btn text-info" data-dismiss="modal" onclick="exportPdf()">PDF</button>
